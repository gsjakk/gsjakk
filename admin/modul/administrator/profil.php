...
<?php
$id=$_SESSION['userkasis'];
include "../config.php";
$sql="SELECT * FROM petugas WHERE userkasis='$id'";
            ...
            <div class="col-md-12 col-sm-12 ">
                ...
                <div class="x_content">
							...
							<div class="x_content">
								<div class="flex">
									<ul class="list-inline widget_profile_box">
										<li>.</li>
										<li>
											<img src="../img/pengguna/<?php echo $r['foto']; ?>" alt="..." class="img-circle profile_img"></center>
										</li>
										<li>.</li>
									</ul>
								</div>
                    ...
                    <div class="col-md-9 ">
						...
						<div class="x_content">
							<br />
							<form class="form-horizontal form-label-left" action="?m=admin&s=update" method="post" enctype="multipart/form-data">
